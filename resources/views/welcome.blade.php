...
{{--    <meta name="keywords" content="creative, modern, clean, bootstrap responsive, html5, css3, portfolio, blog, agency, templates, multipurpose, one page, corporate, start-up, studio, branding, designer, freelancer, carousel, parallax, photography, personal, masonry, grid, faq">--}}
    <!-- Page Title -->
    <title>Ternary Solution | Welcome</title>
    <!-- Favicon -->
    <link rel="icon" href="{{asset('images/favicon.ico')}}">
    <!-- Bundle -->
    <link rel="stylesheet" href="{{asset('megaone/css/bundle.min.css')}}">
    <!-- Plugin Css -->
    <link rel="stylesheet" href="{{asset('megaone/css/jquery.fancybox.min.css')}}">
    <link rel="stylesheet" href="{{asset('megaone/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('megaone/css/swiper.min.css')}}">
    <link rel="stylesheet" href="{{asset('megaone/css/cubeportfolio.min.css')}}">
    <link rel="stylesheet" href="{{asset('megaone/css/wow.css')}}">
    <!-- Slider Settings -->
    <link rel="stylesheet" href="{{asset('megaone/css/LineIcons.min.css')}}">
    <link rel="stylesheet" href="{{asset('megaone/css/settings.css')}}">
    <!-- Style Sheet -->
    <link rel="stylesheet" href="{{asset('megaone/css/style.css')}}">
</head>
...
<div class="navigation-bar">
    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{asset('megaone/img/logo.png')}}" alt="image"></a>
    ...
    <div class="side-menu hidden">
        <div class="inner-wrapper">
            <div class="image">
                <img src="{{asset('megaone/img/side-menu.png')}}" alt="image">
            </div>
            ...
            <div class="side-menu-footer">
                ...
                <p class="copywrite text-left">&#169; 2020 Ternary Solution.</p>
            </div>
        </div>
    </div>
...
{{--            <ul>--}}
{{--                <!-- SLIDE-1 -->--}}
{{--                <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('megaone/img/slide-1.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 2" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">--}}
{{--                    <!-- MAIN IMAGE -->--}}
{{--                    <img src="{{asset('megaone/img/slide-1.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>--}}
...
{{--                </li>--}}
{{--                <!-- SLIDE-2 -->--}}
{{--                <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('megaone/img/slide-2.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 4" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">--}}
{{--                    <!-- MAIN IMAGE -->--}}
{{--                    <img src="{{asset('megaone/img/slide-2.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>--}}
...
{{--                </li>--}}
{{--                <!-- SLIDE-3 -->--}}
{{--                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('megaone/img/slide-3.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 1" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">--}}
{{--                    <!-- MAIN IMAGE -->--}}
{{--                    <img src="{{asset('megaone/img/slide-3.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>--}}
{{--                    <div class="bg-overlay bg-white opacity-2"></div>--}}
{{--                    <!-- LAYERS -->--}}
{{--                    <!-- LAYER NR. 1 -->--}}
{{--                    <div class="tp-caption   tp-resizeme"--}}
...
<div class="team-section" id="team">
    <div class="container">
        ...
        <div class=" text-center team-section-carousel owl-carousel owl-themes active wow zoomIn" data-wow-delay="400ms">
            <div class=" item">
                <img src="{{asset('megaone/img/team-1.jpg')}}" alt="image">
            ...
            <div class=" item" >
                <img src="{{asset('megaone/img/team-2.jpg')}}" alt="image">
                <div class="team-detail">
                    <h5>Andrew Cusik</h5>
                    <p>Marketing Lead</p>
                </div>
            ...
            <div class=" item">
                <img src="{{asset('megaone/img/team-3.jpg')}}" alt="image">
                <div class="team-detail">
                    <h5>Sarah Jenifer</h5>
                    <p>Strategist</p>
                </div>
    ...
    <div class="container">
        ...
        <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat">
            <div class="cbp-item web-design graphic seo">
                <a href="{{asset('megaone/img/work-1.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Bolt UI<br>by Tiberiu Neamu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-1.jpg')}}" alt="">
                    </div>
            ...
            <div class="cbp-item seo marketing">
                <a href="{{asset('megaone/img/work-2.jpg')}}" class="cbp-caption cbp-lightbox" data-title="World Clock<br>by Paul Flavius Nechita">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-2.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item seo marketing">
                <a href="{{asset('megaone')}}/img/work-4.jpg" class="cbp-caption cbp-lightbox" data-title="WhereTO App<br>by Tiberiu Neamu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-4.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item graphic seo marketing">
                <a href="{{asset('megaone/img/work-3.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Seemple* Music<br>by Tiberiu Neamu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-3.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design graphic">
                <a href="{{asset('megaone/img/work-5.jpg')}}" class="cbp-caption cbp-lightbox" data-title="iDevices<br>by Tiberiu Neamu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-5.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item seo marketing graphic">
                <a href="{{asset('megaone/img/work-6.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-6.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design ">
                <a href="{{asset('megaone/img/work-7.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-7.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design graphic">
                <a href="{{asset('megaone/img/work-8.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Digital Menu<br>by Cosmin Capitanu">
                    <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('megaone/img/work-8.jpg')}}" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
...
<script src="{{asset('megaone/js/swiper.min.js')}}"></script>
<script src="{{asset('megaone/js/jquery.cubeportfolio.min.js')}}"></script>
<script src="{{asset('megaone/js/wow.min.js')}}"></script>
<!-- REVOLUTION JS FILES -->
<script src="{{asset('megaone/js/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('megaone/js/jquery.themepunch.revolution.min.js')}}"></script>
<!-- SLIDER REVOLUTION EXTENSIONS -->
<script src="{{asset('megaone/js/extensions/revolution.extension.actions.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.carousel.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.migration.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.navigation.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.parallax.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
<script src="{{asset('megaone/js/extensions/revolution.extension.video.min.js')}}"></script>
<!-- custom script -->
<script src="as{{asset('megaone/js/contact_us.js')}}"></script>
<script src="as{{asset('megaone/js/script.js')}}"></script>
</body>
</html>
